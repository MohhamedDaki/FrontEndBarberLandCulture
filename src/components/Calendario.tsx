...
export const CalendarioCitas = ({ citas }: Props) => {
        ...
        <>
            <div className="bg-white rounded-2xl shadow-xl p-4 border border-gray-200 max-h-[75vh] overflow-y-auto">
                <FullCalendar
                    ...
                    expandRows={true}
                    slotEventOverlap={false} // evita que se superpongan
                    eventMaxStack={3} // controla cuántos eventos apilar antes de poner "más"
                    eventDisplay="block" // asegura que los eventos usen espacio completo
                />
            </div>
